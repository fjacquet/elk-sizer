...
export function exportPPTX(results: CalculationResults, title: string): void {
  ...
  slide2.addTable(
    [
      [
        ...
        { text: 'Value', options: { bold: true, color: LIGHT_TEXT, fill: { color: BRAND_GREEN } } },
      ],
  ...
  slide3.addTable(
    [
      [
        { text: 'Tier', options: { bold: true, color: LIGHT_TEXT, fill: { color: BRAND_GREEN } } },
        { text: 'Nodes', options: { bold: true, color: LIGHT_TEXT, fill: { color: BRAND_GREEN } } },
        {
          text: 'Storage (GB)',
          options: { bold: true, color: LIGHT_TEXT, fill: { color: BRAND_GREEN } },
        },
  ...
  slide4.addTable(
    [
      [
        { text: 'Model', options: { bold: true, color: LIGHT_TEXT, fill: { color: BRAND_GREEN } } },
        { text: 'Role', options: { bold: true, color: LIGHT_TEXT, fill: { color: BRAND_GREEN } } },
